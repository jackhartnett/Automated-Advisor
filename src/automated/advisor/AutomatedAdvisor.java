 ...
 * @author Jonathan
 */
public class AutomatedAdvisor extends Application {
    ...
    public void start(final Stage primaryStage) {
        ...
        Text scenetitle = new Text("Major Courses Check");
        scenetitle.setFont(Font.font("Californian FB", FontWeight.NORMAL, 30));
        grid.add(scenetitle, 0, 0, 2, 1);

        Button btnS = new Button("Getting A BS");
        HBox btnBS = new HBox(10);
        btnBS.setAlignment(Pos.CENTER_RIGHT);
        ...
        btnS.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                scenetitle.setFont(Font.font("Papyrus", FontWeight.NORMAL, 24));
                vbchecks = new VBox();
                ...
                CS114 = new CheckBox("CS 114");
                CS115 = new CheckBox("CS 115");
                CS211 = new CheckBox("CS 211");
                CS220 = new CheckBox("CS 220");
                CS320 = new CheckBox("CS 320");
                CS460 = new CheckBox("CS 460");
                M144 = new CheckBox("M 144");
                M221W = new CheckBox("M 221W");
                ...
                Scene BSscene = new Scene(BSgrid, 600, 550);
                ...
                Sub.setOnAction(new EventHandler<ActionEvent>() {
                    public void handle(ActionEvent event) {
                        ...
                        B110 = new CheckBox("BIO 110");
                        B111 = new CheckBox("BIO 111");
                        C110 = new CheckBox("CHEM 110");
                        C111 = new CheckBox("CHEM 111");
                        P112 = new CheckBox("PHY 112");
                        P113 = new CheckBox("PHY 113");
                        P120 = new CheckBox("PHY 120");
                        P121 = new CheckBox("PHY 121");

                        vbchecks.getChildren().addAll(B110, B111, C110, C111, P112, P113, P120, P121);
                        B110.setOnAction(e -> handleButtonAction(e));
                        B111.setOnAction(e -> handleButtonAction(e));
                        C110.setOnAction(e -> handleButtonAction(e));
                        C111.setOnAction(e -> handleButtonAction(e));
                        P112.setOnAction(e -> handleButtonAction(e));
                        P113.setOnAction(e -> handleButtonAction(e));
                        P120.setOnAction(e -> handleButtonAction(e));
                        P121.setOnAction(e -> handleButtonAction(e));
                        final Stage ClassStage = new Stage();
                        ...
                        Sub.setOnAction(new EventHandler<ActionEvent>() {
                            public void handle(ActionEvent event) {
                                ...
                                CS362 = new CheckBox("CS 362");
                                CS451 = new CheckBox("CS 451");
                                E231 = new CheckBox("ECE231 & ECE232");
                                CS275 = new CheckBox("CS 275");
                                CS351 = new CheckBox("CS 351");
                                CS365 = new CheckBox("CS 365");
                                CS371 = new CheckBox("CS 371");
                                CS375 = new CheckBox("CS 375");
                                CS340 = new CheckBox("CS 340");
                                M220 = new CheckBox("M 220");
                                M222W = new CheckBox("M 222W");
                                Button tbBS = new Button("test");

                                vbchecks.getChildren().addAll(CS362, CS451, E231, CS275, CS351, CS365, CS371, CS375, CS340, M220, M222W, tbBS);
                                ...
                                tbBS.setOnAction(e -> testBreadthCS(e));
                                final Stage ClassStage = new Stage();
                                ...
                                Sub.setOnAction(new EventHandler<ActionEvent>() {
                                    public void handle(ActionEvent event) {
                                        ...
                                        scenetitle.setFont(Font.font("Papyrus", FontWeight.NORMAL, 25));
                            ...
                            private void testBreadthCS(ActionEvent e) {
                                System.out.println(BSElectives.checkBreadth());
                            }
                        });
        ...
        btnBA.setAlignment(Pos.CENTER_RIGHT);
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        Sub.setOnAction(new EventHandler<ActionEvent>() {
                            public void handle(ActionEvent event) {
                                ...
                                vbchecks.getChildren().addAll(CS362, CS451, E231, CS275, CS351, CS365, CS371, CS375, CS340, M220, M222W, tb);
                                ...
                                tb.setOnAction(e -> testBreadth(e));
                                final Stage ClassStage = new Stage();
                                ClassStage.setTitle("Select All Your CS Electives");
                            ...
                            private void testBreadth(ActionEvent e) {
                                System.out.println(BAElectives.checkBreadth());
                            }
        ...
        Button btnTS = new Button("Transfer BS");
        HBox btnTBS = new HBox(10);

        btnTBS.setAlignment(Pos.CENTER_RIGHT);
        ...
        btnTS.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        Sub.setOnAction(new EventHandler<ActionEvent>() {
                            public void handle(ActionEvent event) {
                                ...
                                CS362 = new CheckBox("CS 362");
                                CS451 = new CheckBox("CS 451");
                                E231 = new CheckBox("ECE 231");
                                E232 = new CheckBox("ECE 232");
                                CS275 = new CheckBox("CS 275");
                                CS351 = new CheckBox("CS 351");
                                CS365 = new CheckBox("CS 365");
                                CS371 = new CheckBox("CS 371");
                                ...
                                vbchecks.getChildren().addAll(CS362, CS451, E231, E232, CS275, CS351, CS365, CS371, CS375, CS340, M220, M222W);
        ...
        Button btnTA = new Button("Transfer BA");
        HBox btnTBA = new HBox(10);
        btnTBA.setAlignment(Pos.CENTER_RIGHT);
        btnTBA.getChildren().add(btnTA);
        grid.add(btnTBA, 1, 3);

        btnTA.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                primaryStage.close();
